...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(AssetBundleDownloader), AssetBundleDownloaderWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(SkillWave), SkillWaveWrap.__Register);
